...
const Budget = () => {
    ...
    return (
        <div className='budget'>
            ...
            <p className='budget__description'>Start with a preset budget and see what your options are.</p>
            ...
            <div className='budget__btn-container'>
                ...
                <button className='budget__btn-container-item budget__btn-container-item--active'>Less than $100/mo</button>
                <button className='budget__btn-container-item'>No present budget</button>
            </div>
        </div>
